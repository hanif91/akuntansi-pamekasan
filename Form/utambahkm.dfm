object fotambahkasmasuk: Tfotambahkasmasuk
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'Tambah Transaksi Kas Masuk'
  ClientHeight = 454
  ClientWidth = 323
  Color = clBtnFace
