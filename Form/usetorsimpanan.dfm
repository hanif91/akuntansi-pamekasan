object fosetorsimpanan: Tfosetorsimpanan
  Left = 0
  Top = 0
      ...
      object RzPanel1setorsimp: TRzPanel
        ...
        object RzPanel4: TRzPanel
          ...
          object cxLabel2: TcxLabel
            ...
            Align = alTop
            AutoSize = False
            Caption = 'Detail Setoran Simpanan'
            ParentFont = False
  ...
  object Qsimpanan: TMyQuery
    SQLRefresh.Strings = (
        ...
        'LEFT JOIN (SELECT SUM(kredit) AS total,notrans FROM d_simp_anggo' +
        'ta GROUP BY notrans) c ON a.notrans=c.notrans'
      'WHERE a.kaskredit="-"')
    Connection = dm.Conn1
    SQL.Strings = (
  ...
  object QDetail: TMyQuery
    SQLRefresh.Strings = (
        ...
        'SELECT a.idsimpanan,b.namasimpanan,a.kredit FROM d_simp_anggota ' +
        'a LEFT JOIN jenis_simpanan b ON a.`idsimpanan`=b.`idsimpanan`'
