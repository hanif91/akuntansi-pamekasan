...
type
  Tfodspk = class(TForm)
    ...
    Qjunamakas: TMemoField;
    cxGrid1DBTableView1namakas: TcxGridDBColumn;
    Qdjuid: TIntegerField;
    Qdjutanggal: TDateField;
    Qdjunamakas: TStringField;
    Qdjujumlah: TFloatField;
    Qdjutglpost: TDateTimeField;
    Qdjukodeunit: TStringField;
    cxGridDBTableView1namakas: TcxGridDBColumn;
...
procedure Tfodspk.cxComboBox1PropertiesChange(Sender: TObject);
begin
  cxComboBox2.ItemIndex := cxComboBox1.ItemIndex;
end;

procedure Tfodspk.cxGrid1DBTableView1FocusedRecordChanged(
  Sender: TcxCustomGridTableView; APrevFocusedRecord,
...
procedure Tfodspk.FormShow(Sender: TObject);
begin
  dm.isicombo2('periodeposting',cxComboBox1,cxComboBox2);
end;

procedure Tfodspk.HapusDataPenerimaan1Click(Sender: TObject);
begin
...
procedure Tfodspk.RzToolButton1Click(Sender: TObject);
begin
  Qju.Close;
  Qju.SQL.Clear;
