...
procedure Tfotambahtarik.btnkembaliClick(Sender: TObject);
begin
  if mode<>0 then
  kosongkantext;
  Self.Close;
...
procedure Tfotambahtarik.btnsimpanClick(Sender: TObject);
var
 i : integer;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        MessageDlg('Jumlah Penarikan Masih 0',mtWarning,[mbok],0);
      end
      else
      begin
        with dm do
        begin
          ...
          begin
            ...
            if MessageDlg('Yakin Menyimpan Penarikan Dengan Total "'+cxGrid1DBTableView1.DataController.Summary.FooterSummaryTexts[0]+'" ini >',mtConfirmation,[mbyes,mbno],0)=mryes then
            begin
              try
                ...
                begin
                  ...
                  begin
                    ...
                    Qex.SQL.Add('value ((Select noautosimp(:tglmutasi,"K")),:idsimpanan,:debet,:kredit);');
                    Qex.ParamByName('tglmutasi').AsDate := cxDateEdit1.Date;
                    Qex.ParamByName('idsimpanan').AsInteger := dxMemData1idsimpanan.Value;
                    Qex.ParamByName('debet').AsCurrency := dxMemData1setor.Value;
                ...
                Qex.SQL.Add('value ((Select noautosimp(:tglmutasi,"K")),:tglmutasi,:idanggota,:kasdebet,:kaskredit,NOW(),:keterangan);');
                Qex.ParamByName('tglmutasi').AsDate := cxDateEdit1.Date;
                Qex.ParamByName('kasdebet').AsString := '-';
          ...
          begin
            ...
            begin
              if MessageDlg('Yakin Koreksi Penarikan Dengan Total "'+cxGrid1DBTableView1.DataController.Summary.FooterSummaryTexts[0]+'" ini >',mtConfirmation,[mbyes,mbno],0)=mryes then
              begin
                try
                  Conn1.StartTransaction;
                  dxMemData1.First;
                  ...
                  begin
                    ...
                    begin
                      ...
                      begin
                        Qex.Close;
                        Qex.SQL.Clear;
                        Qex.SQL.Add('update d_simp_anggota set debet=:debet where id=:id');
...
function Tfotambahtarik.cekisiankosong: Boolean;
begin
...
procedure Tfotambahtarik.cxButton1Click(Sender: TObject);
var
  periode : tdate;
begin
  if mode=0 then
  begin
    ...
    begin
      Qcek.Close;
      Qcek.SQL.Clear;
      Qcek.SQL.Add('select noautosimp(:tgl)');
...
procedure Tfotambahtarik.cxDateEdit1PropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  cxButton1.Click;
end;

procedure Tfotambahtarik.dxMemData1setorValidate(Sender: TField);
begin
...
procedure Tfotambahtarik.FormShow(Sender: TObject);
begin
  if mode=0 then
  begin
    try
...
procedure Tfotambahtarik.isimemdata;
var
  i : byte;
begin
  dxMemData1.Close;
...
procedure Tfotambahtarik.kosongkantext;
begin
...
procedure Tfotambahtarik.RzPageControl1Close(Sender: TObject;
