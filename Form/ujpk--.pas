...
uses
  ...
  frxDesgn, usettgllap, System.Actions, Vcl.ActnList, dxSkinTheBezier,
...
procedure Tfojpk.cxButton5Click(Sender: TObject);
begin
  Qju.Close;
  Qju.SQL.Clear;
...
procedure Tfojpk.cxCheckBox1Click(Sender: TObject);
begin
  if cxCheckBox1.Checked then
  begin
...
procedure Tfojpk.cxCheckBox2Click(Sender: TObject);
begin
  if cxCheckBox2.Checked then
  begin
...
procedure Tfojpk.cxCheckBox3Click(Sender: TObject);
begin
  if cxCheckBox3.Checked then
  begin
...
procedure Tfojpk.cxCheckBox4Click(Sender: TObject);
begin
  if cxCheckBox4.Checked then
  begin
...
procedure Tfojpk.cxGrid1DBTableView1FocusedRecordChanged(
  Sender: TcxCustomGridTableView; APrevFocusedRecord,
...
procedure Tfojpk.cxTextEdit1KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 then
  begin
    cxButton5.Click;
...
procedure Tfojpk.F7Execute(Sender: TObject);
begin
  lapjpk.LoadFromFile(ExtractFilePath(Application.ExeName)+'report\lapjpk.fr3');
...
procedure Tfojpk.Koreksi1Click(Sender: TObject);
var
  i : integer;
begin
  with dm do
  begin
    Qcek.Close;
    Qcek.SQL.Clear;
    Qcek.SQL.Add('CALL ceknotrans(:notrans)');
    ...
    begin
      ...
      begin
        if Qcek.FieldByName('kode').AsString='KM' then
        begin
          Qdetail.Close;
          Qdetail.SQL.Clear;
          Qdetail.SQL.Add('SELECT a.*,b.`idcoa` FROM d_kasmasuk a LEFT JOIN ketkas b ON a.namaketkas=b.namaketkas where a.notrans=:notrans');
          ...
          begin
            try
              ...
              begin
                ...
                Qex.ParamByName('kredit').AsCurrency := Qdetail.FieldByName('jumlah').AsCurrency;
                Qex.Execute;
        ...
        if Qcek.FieldByName('kode').AsString='SM' then
        begin
          Qdetail.Close;
          Qdetail.SQL.Clear;
          Qdetail.SQL.Add('SELECT a.*,b.`idcoa` FROM d_simp_anggota a LEFT JOIN jenis_simpanan b ON a.idsimpanan=b.idsimpanan WHERE a.notrans=:notrans');
          Qdetail.ParamByName('notrans').AsString :=Qjunoref.Text;
          Qdetail.Open;
          if Qdetail.RecordCount > 0 then
          begin
            try
              ...
              begin
                ...
                Qex.ParamByName('jenis').AsString := '';
                Qex.ParamByName('debet').AsCurrency := 0;
                Qex.ParamByName('kredit').AsCurrency := Qdetail.FieldByName('kredit').AsCurrency;
                Qex.Execute;
        ...
        if Qcek.FieldByName('kode').AsString='KT' then
        begin
          try
            Conn1.StartTransaction;
            ...
            Qex.SQL.Clear;
            Qex.SQL.Add('Insert into jpk_ (idcoa,idju,tanggal,jenis,debet,kredit) value (:idcoa,:idju,:tanggal,:jenis,:debet,:kredit)');
            Qex.ParamByName('idcoa').AsInteger := Qcek.FieldByName('idcoadebet').AsInteger;
            Qex.ParamByName('idju').AsInteger := Qjuidju.Value;
            Qex.ParamByName('tanggal').AsDate := Qcek.FieldByName('tanggal').AsDateTime;
            Qex.ParamByName('jenis').AsString := '';
            Qex.ParamByName('debet').AsCurrency := Qcek.FieldByName('total').AsCurrency;
        ...
        begin
          try
            ...
            Qex.SQL.Clear;
            Qex.SQL.Add('Insert into jpk_ (idcoa,idju,tanggal,jenis,debet,kredit) value (:idcoa,:idju,:tanggal,:jenis,:debet,:kredit)');
            Qex.ParamByName('idcoa').AsInteger := Qcek.FieldByName('idcoapokok').AsInteger;
            Qex.ParamByName('idju').AsInteger := Qjuidju.Value;
            Qex.ParamByName('tanggal').AsDate := Qcek.FieldByName('tanggal').AsDateTime;
            Qex.ParamByName('jenis').AsString := '';
            Qex.ParamByName('debet').AsCurrency := 0;
            ...
            Qex.SQL.Clear;
            Qex.SQL.Add('Insert into jpk_ (idcoa,idju,tanggal,jenis,debet,kredit) value (:idcoa,:idju,:tanggal,:jenis,:debet,:kredit)');
            Qex.ParamByName('idcoa').AsInteger := Qcek.FieldByName('idcoabunga').AsInteger;
            Qex.ParamByName('idju').AsInteger := Qjuidju.Value;
            Qex.ParamByName('tanggal').AsDate := Qcek.FieldByName('tanggal').AsDateTime;
            Qex.ParamByName('jenis').AsString := '';
            Qex.ParamByName('debet').AsCurrency := 0;
            ...
            begin
              ...
              Qex.SQL.Clear;
              Qex.SQL.Add('Insert into jpk_ (idcoa,idju,tanggal,jenis,debet,kredit) value (:idcoa,:idju,:tanggal,:jenis,:debet,:kredit)');
              Qex.ParamByName('idcoa').AsInteger := Qcek.FieldByName('idcoadenda').AsInteger;
              Qex.ParamByName('idju').AsInteger := Qjuidju.Value;
              Qex.ParamByName('tanggal').AsDate := Qcek.FieldByName('tanggal').AsDateTime;
              Qex.ParamByName('jenis').AsString := '';
              Qex.ParamByName('debet').AsCurrency := 0;
...
begin
  if fotambahjpk.ShowModal=mrok then
  begin
    Qju.Refresh;
  end
  else
...
procedure Tfojpk.RzToolButton2Click(Sender: TObject);
var
